# Generated by Django 3.2.22 on 2023-12-15 22:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts', to='recipes.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liked_posts', models.ManyToManyField(blank=True, related_name='liked_by', to='recipes.Post')),
